...
### Version Bumping (Published Packages)
...
- **Patch** (e.g. 0.0.6 → 0.0.10): Backward-compatible fixes, additive types/schemas, new optional fields.
- **Minor** (e.g. 0.0.10 → 0.1.0): New backward-compatible features.
